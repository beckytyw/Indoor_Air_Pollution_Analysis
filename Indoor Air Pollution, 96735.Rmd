---
title: "Indoor Air Pollution, 96735"
...
`Deaths (% of Population)` = (`Number of Deaths by Indoor Air Pollution` / `Population (historical estimates)`) x 100 
...
plot <- ggplot(deaths_fuel_continent) +
  ...
  labs(title = "Access to Cooking Fuels vs Deaths by Indoor Air Pollution",
       ...
       caption = "The area graph represents the percentage of deaths by continents over the years, whilst the points represent the percentage of access to clean fuel by population") +
...
In conclusion, these visualisations highlight the complex interplay between a continent’s wealth, access to clean fuels and cooking technologies, and indoor air pollution deaths. While access to clean fuels and cooking technologies is generally lower in poorer countries, economic development and improved access to clean energy solutions can contribute to a reduction in indoor air pollution-related mortality. Therefore, to answer the overarching question, the relationship between a continent’s GDP per capita and the number of deaths caused by indoor air pollution is an inverse one, since the richer the country (as indicated by higher GDP per capita), the lower the death rate caused by indoor air pollution. Thus, addressing disparities in access to clean fuels and promoting sustainable economic growth are crucial steps towards mitigating the adverse health effects of indoor air pollution globally. 
...
| Avril Moh Ying Xuan |   2   | Data Science & Analytics  | Data Cleaning, visualisation of first graph|
| Phua Wei Jie Ryan |   2  |Data Science & Analytics| Data Cleaning, visualisation of second graph|
| Roderich Suwandi Lee |   2   | Data Science & Analytics| Data Cleaning, visualisation of third graph|
